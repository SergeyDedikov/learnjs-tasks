...
какую структуру данных вы могли бы использовать 
...
добавлять туда свойства. 
Если сообщения принадлежат какому-то другому коду, 
...
// добавляем прочтённые сообщения во временное хранилище
readMessages.add(messages[0]);
readMessages.add(messages[1]);
readMessages.add(messages[0]); // повторы пропускаются

// проверяем, было ли сообщение прочтено
